...
#define GAIN_PROPORTIONAL_ROLL  0.0f
#define GAIN_PROPORTIONAL_PITCH 0.0f
#define GAIN_PROPORTIONAL_YAW   0.0f
/*
#define GAIN_DERIVATIVE_ROLL   0.0f
#define GAIN_DERIVATIVE_PITCH  0.0f
#define GAIN_DERIVATIVE_YAW    0.0f


#define GAIN_PROPORTIONAL_ROLL  -0.25f
#define GAIN_PROPORTIONAL_PITCH -0.25f
#define GAIN_PROPORTIONAL_YAW   0.05f
*/
#define GAIN_DERIVATIVE_ROLL   -0.0022f
#define GAIN_DERIVATIVE_PITCH  -0.0022f
#define GAIN_DERIVATIVE_YAW    -0.0016f
/*
#define GAIN_PROPORTIONAL_ROLL  -0.5f
#define GAIN_PROPORTIONAL_PITCH -0.5f
#define GAIN_PROPORTIONAL_YAW   0.04f
#define GAIN_DERIVATIVE_ROLL   -0.0016f
#define GAIN_DERIVATIVE_PITCH  -0.0016f
#define GAIN_DERIVATIVE_YAW    -0.003f
*/
