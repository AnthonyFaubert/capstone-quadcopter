...
#define LIMIT_GYRO_ERROR_ROLL 100.0f
#define LIMIT_GYRO_ERROR_PITCH 100.0f
#define LIMIT_GYRO_ERROR_YAW 100.0f

// Gain values for PID
#define GAIN_PROPORTIONAL_ROLL  -0.08f
#define GAIN_PROPORTIONAL_PITCH -0.08f
#define GAIN_PROPORTIONAL_YAW   0.1f
#define GAIN_DERIVATIVE_ROLL   -0.002f
#define GAIN_DERIVATIVE_PITCH  -0.002f
